...
const Home = () => {
  ...
  // List of all items to be swiped
  const items = [
    'Call Routing',
    'Answering FAQs',
    'Bookings & Reservations',
  ...
  // Function to handle previous and next item navigation
...
<div className="flex flex-col md:flex-row justify-between px-2 md:px-8 lg:px-8 py-10 space-y-8 md:space-y-0 md:space-x-12 mt-0 md:mt-8">
  ...
  <div className="border-t-2 border-green-200 animate-pulse border-dashed w-full my-4 "></div>
</div>
